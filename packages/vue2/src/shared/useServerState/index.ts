...
import { IConfig, fetcherFn, IKey } from 'swrv/dist/types'
...
function useServerState<Data, Error = any>(key: IKey, fetcher?: fetcherFn<Data>, options?: Omit<IOptions<Data>, 'initialData'>): IUseServerStateReturn<Data | undefined>

function useServerState<Data, Error = any>(key: IKey, fetcher?: fetcherFn<Data>, options?: IOptions<Data>): IUseServerStateReturn<Data>

function useServerState<Data, Error = any>(key: IKey, fetcher?: fetcherFn<Data>, options?: IOptions<Data>) {
